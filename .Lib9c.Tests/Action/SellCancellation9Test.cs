namespace Lib9c.Tests.Action
{
    ...
    public class SellCancellation9Test
    {
        ...
        public SellCancellation9Test(ITestOutputHelper outputHelper)
        {
        ...
        )
        {
            ...
            var sellCancellationAction = new SellCancellation9
            {
                orderId = orderId,
        ...
        {
            var action = new SellCancellation9
            {
                orderId = default,
        ...
        public void PlainValue()
        {
            ...
            var action2 = new SellCancellation9();
