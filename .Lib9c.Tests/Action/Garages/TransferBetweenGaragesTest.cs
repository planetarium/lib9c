...
#nullable enable
    ...
    public class TransferBetweenGaragesTest
    {
        ...
        public TransferBetweenGaragesTest()
        {
            ...
            (HashDigest<SHA256> fungibleId, int count)[] fungibleIdAndCounts)
        {
            ...
            foreach (var action in actions)
            {
                ...
                var des = new TransferBetweenGarages();
                ...
                var actionInter = (ITransferBetweenGarages)action;
                var desInter = (ITransferBetweenGarages)des;
        ...
        private static (TransferBetweenGarages action, IAccountStateDelta nextStates) Execute(
            Address signer,
            long blockIndex,
        ...
        {
            var action = new TransferBetweenGarages(
                recipientAgentAddr,
                fungibleAssetValues,
                fungibleIdAndCounts);
            return (
