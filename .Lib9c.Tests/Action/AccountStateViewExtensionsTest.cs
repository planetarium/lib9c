namespace Lib9c.Tests.Action
{
    ...
    public class AccountStateViewExtensionsTest
    {
        ...
        {
            var states = new World(new MockWorldState()).SetState(default, Dictionary.Empty);
        ...
        {
            var states = new World(new MockWorldState()).SetState(default, default(Text));
        ...
        {
            var states = new World(new MockWorldState()).SetState(default, _avatarState.Serialize());
        ...
        public void GetAvatarStateV2_Throw_FailedLoadStateException(string key)
        {
            ...
            states = states.SetAccount(
                ...
                states.GetAccount(ReservedAddresses.LegacyAccount).SetNull(_avatarAddress.Derive(key)));
        ...
        public void GetCrystalCostState(bool exist)
        {
            ...
            if (exist)
            {
                states = states.SetState(address, crystalCostState.Serialize());
            }
