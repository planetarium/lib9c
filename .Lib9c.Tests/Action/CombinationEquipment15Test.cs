namespace Lib9c.Tests.Action
{
    ...
    public class CombinationEquipment15Test
    {
        ...
        public CombinationEquipment15Test(ITestOutputHelper outputHelper)
        {
...
#pragma warning restore CS0618
        ...
        )
        {
            ...
            var action = new CombinationEquipment15
            {
        ...
        public void AddAndUnlockOption()
        {
            ...
            var equipment = (Necklace)ItemFactory.CreateItemUsable(
                ...
                default);
            Assert.Equal(0, equipment.optionCountFromCombination);
            CombinationEquipment15.AddAndUnlockOption(
                _agentState,
                equipment,
                _random,
                subRecipe,
