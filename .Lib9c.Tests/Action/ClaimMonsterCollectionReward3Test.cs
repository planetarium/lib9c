namespace Lib9c.Tests.Action
{
    ...
    public class ClaimMonsterCollectionReward3Test
    {
        ...
        public ClaimMonsterCollectionReward3Test(ITestOutputHelper outputHelper)
        {
        ...
        public void Execute(int collectionLevel, long claimBlockIndex, long? receivedBlockIndex, (int, int)[] expectedRewards, Type exc)
        {
            ...
            ClaimMonsterCollectionReward3 action = new ClaimMonsterCollectionReward3
            {
