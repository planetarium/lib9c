namespace Lib9c.Tests.Action
{
    ...
    public class GrindingTest
    {
        ...
        [Theory]
        [InlineData(true, true, 120, false, false, true, 1, 0, false, false, 0, 10, 1, null)]
        [InlineData(true, true, 120, false, false, true, 1, 2, false, false, 0, 40, 1, null)]
        [InlineData(true, true, 120, false, false, true, 1, 2, false, true, 0, 40, 1, null)]
        [InlineData(true, true, 120, false, false, true, 1, 0, false, true, 3, 13, 1, null)]
        [InlineData(true, true, 120, false, false, true, 1, 2, false, true, 4, 56, 1, null)]
        // Charge AP.
        [InlineData(true, true, 0, true, true, true, 1, 0, false, false, 0, 10, 1, null)]
