namespace Lib9c.Tests.Action
{
    ...
    public class BattleArena9Test
    {
        ...
        public BattleArena9Test(ITestOutputHelper outputHelper)
        {
...
#pragma warning restore CS0618
        ...
        public void Execute_AddressNotFoundInArenaParticipantsException(bool excludeMe)
        {
            ...
            if (!row.TryGetRound(round, out var roundData))
            {
                throw new RoundNotFoundException(
                    $"[{nameof(BattleArena9)}] ChampionshipId({row.ChampionshipId}) - round({round})");
            }
        ...
        public void Execute_ExceedTicketPurchaseLimitDuringIntervalException()
        {
            ...
            var purchasedCountDuringInterval = arenaInfoAdr.Derive(BattleArena9.PurchasedCountKey);
        ...
        public void Execute_ValidateDuplicateTicketPurchaseException()
        {
            ...
            {
                throw new InvalidSeasonException($"[{nameof(BattleArena9)}] This test is only for OffSeason. ArenaType : {roundData.ArenaType}");
            }
