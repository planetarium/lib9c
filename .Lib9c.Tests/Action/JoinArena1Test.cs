...
#pragma warning restore CS0618
        ...
        public void Execute(long blockIndex, int championshipId, int round, string balance)
        {
            ...
            // ArenaInformation
            var arenaInformationAdr = ArenaInformationV1.DeriveAddress(_avatarAddress, championshipId, round);
            var serializedArenaInformation = (List)state.GetState(arenaInformationAdr);
            var arenaInformation = new ArenaInformationV1(serializedArenaInformation);
            ...
            Assert.Equal(ArenaInformationV1.MaxTicketCount, arenaInformation.Ticket);
        ...
        public void Execute_ArenaInformationAlreadyContainsException()
        {
            ...
            var arenaInformationAdr = ArenaInformationV1.DeriveAddress(_avatarAddress, championshipId, round);
            var arenaInformation = new ArenaInformationV1(_avatarAddress, championshipId, round);
