namespace Lib9c.Tests.Model
{
    ...
    public class OrderReceiptListTest
    {
        ...
        public void Add()
        {
            ...
            orderReceiptList.Add(_order);

            Assert.Single(orderReceiptList.ReceiptList);
            OrderReceiptList.OrderReceipt orderReceipt = orderReceiptList.ReceiptList.First();
            ...
            Assert.Throws<DuplicateOrderIdException>(() => orderReceiptList.Add(_order));
        }
