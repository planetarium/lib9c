namespace Lib9c.Tests.Model
{
    ...
    public class ActivationKeyTest
    {
        ...
        public void Encode()
        {
            var privateKey = new PrivateKey(ByteUtil.ParseHex("ac84ad2eb0bc62c63e8c4e4f22f7c19d283b36e60fdc4eed182d4d7a7bb4c716"));
            var nonce = new byte[] { 0x00, 0x01, 0x02, 0x03, };
            var (ak, _) = ActivationKey.Create(privateKey, nonce);
        ...
        public void Decode()
        {
            var encoded = "ac84ad2eb0bc62c63e8c4e4f22f7c19d283b36e60fdc4eed182d4d7a7bb4c716/46c4365d645647791768b9a9e6e4a9376b15c643";
            var ak = ActivationKey.Decode(encoded);
