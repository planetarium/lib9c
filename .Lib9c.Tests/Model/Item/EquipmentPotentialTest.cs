    ...
    public class EquipmentPotentialTest
    {
        ...
        public void Serialize_WithSlots_RoundTrips()
        {
            var potential = new EquipmentPotential(
                ...
                {
                    new PotentialOptionSlot(700001, 12L),
                    new PotentialOptionSlot(700002, 3L),
                    new PotentialOptionSlot(700003, 1500L),
                });
            ...
            Assert.Equal(3L, deserialized.Slots[1].Value);
            Assert.Equal(1500L, deserialized.Slots[2].Value);
            Assert.Equal(serialized, deserialized.Serialize());
        }
        ...
        {
            var slot = new PotentialOptionSlot(700010, 42L);
