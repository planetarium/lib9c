namespace Lib9c.Tests.Delegation
{
    ...
    public class DelegatorTest
    {
        ...
        public void CtorWithBencoded()
        {
            ...
            repo.MintAsset(delegator.Address, delegatee.Currency * 100);
            delegator.Delegate(delegatee, delegatee.Currency * 10, 10L);
        ...
        public void Delegate()
        {
            ...
            var delegatorInitialBalance = delegatee1.Currency * 100;
            ...
            var delegatorBalance = repo.World.GetBalance(delegator.Address, delegatee1.Currency);
            var delegateeBalance = repo.World.GetBalance(delegatee1.DelegationPoolAddress, delegatee1.Currency);
            ...
            delegatorBalance = repo.World.GetBalance(delegator.Address, delegatee1.Currency);
            delegateeBalance = repo.World.GetBalance(delegatee1.DelegationPoolAddress, delegatee1.Currency);
            ...
            delegatorBalance = repo.World.GetBalance(delegator.Address, delegatee2.Currency);
            delegateeBalance = repo.World.GetBalance(delegatee2.DelegationPoolAddress, delegatee2.Currency);
        ...
        public void Undelegate()
        {
            ...
            var delegator = _fixture.TestDelegator1;
            var delegatee = _fixture.TestDelegatee1;
            var delegatorInitialBalance = delegatee.Currency * 100;
            repo.MintAsset(delegator.Address, delegatorInitialBalance);
            var delegatingFAV = delegatee.Currency * 10;
            ...
            var delegatorBalance = repo.World.GetBalance(delegator.Address, delegatee.Currency);
            var delegateeBalance = repo.World.GetBalance(delegatee.DelegationPoolAddress, delegatee.Currency);
            ...
            delegatorBalance = repo.World.GetBalance(delegator.Address, delegatee.Currency);
            delegateeBalance = repo.World.GetBalance(delegatee.DelegationPoolAddress, delegatee.Currency);
            ...
            Assert.Equal(delegatee.Currency * 0, delegatee.TotalDelegated);
            ...
            Assert.Equal(delegatee.Currency * 0, delegateeBalance);
        }
        ...
        public void Redelegate()
        {
            ...
            var delegatorInitialBalance = delegatee1.Currency * 100;
            repo.MintAsset(delegator.Address, delegatorInitialBalance);
            var delegatingFAV = delegatee1.Currency * 10;
            ...
            var delegatorBalance = repo.World.GetBalance(delegator.Address, delegatee1.Currency);
            var delegatee1Balance = repo.World.GetBalance(delegatee1.DelegationPoolAddress, delegatee1.Currency);
            var delegatee2Balance = repo.World.GetBalance(delegatee2.DelegationPoolAddress, delegatee2.Currency);
            ...
            delegatorBalance = repo.World.GetBalance(delegator.Address, delegatee1.Currency);
            delegatee1Balance = repo.World.GetBalance(delegatee1.DelegationPoolAddress, delegatee1.Currency);
            delegatee2Balance = repo.World.GetBalance(delegatee2.DelegationPoolAddress, delegatee2.Currency);
        ...
        public void RewardOnDelegate()
        {
            ...
            var reward = delegatee.Currency * 100;
            repo.MintAsset(delegatee.RewardPoolAddress, reward);
            // EndBlock after delegatee's reward
            repo.Reward(delegatee, 10L, reward);

            var delegatingFAV1 = delegatee.Currency * 10;
            delegator1.Delegate(delegatee, delegatingFAV1, 10L);
            var delegator1Balance = repo.World.GetBalance(delegator1.Address, delegatee.Currency);
            var delegateeBalance = repo.World.GetBalance(delegatee.DelegationPoolAddress, delegatee.Currency);
            ...
            var delegatingFAV2 = delegatee.Currency * 20;
            delegator2.Delegate(delegatee, delegatingFAV2, 10L);
            var delegator2Balance = repo.World.GetBalance(delegator2.Address, delegatee.Currency);
            delegateeBalance = repo.World.GetBalance(delegatee.DelegationPoolAddress, delegatee.Currency);
            ...
            delegatingFAV1 = delegatee.Currency * 10;
            delegator1.Delegate(delegatee, delegatingFAV1, 11L);
            delegator1Balance = repo.World.GetBalance(delegator1.Address, delegatee.Currency);
            var rewardPoolBalance = repo.World.GetBalance(delegatee.RewardPoolAddress, delegatee.Currency);
            ...
            delegator2Balance = repo.World.GetBalance(delegator2.Address, delegatee.Currency);
            rewardPoolBalance = repo.World.GetBalance(delegatee.RewardPoolAddress, delegatee.Currency);
