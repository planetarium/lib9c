namespace Lib9c.Tests.TestHelper
{
    ...
    public static class BencodexHelper
    {
        ...
        public static void AssertEquals(IValue expected, IValue actual)
        {
            ...
            var expectedInspection = expected?.ToString() ?? "(null)";
            var actualInspection = actual?.ToString() ?? "(null)";
            var diffModel = InlineDiffBuilder.Diff(expectedInspection, actualInspection);
