...
{
    [ActionType("transfer_between_garages")]
    public class TransferBetweenGarages : GameAction, ITransferBetweenGarages, IAction
    {
            ...
            IEnumerable<(HashDigest<SHA256> fungibleId, int count)>? fungibleIdAndCounts)
        {
            ...
            SetInternal(fungibleAssetValues, fungibleIdAndCounts);
        }
...
#pragma warning restore LAA1002
            ...
            IAccountStateDelta states)
        {
                     ...
                     fungibleItemTuples)
            {
                ...
                senderGarage.TransferTo(recipientGarage, count);
                states = states
