...
namespace Nekoyume.Action
{
    ...
    public class ClaimStakeReward8 : GameAction, IClaimStakeReward, IClaimStakeRewardV1
    {
...
";
        ...
        public ClaimStakeReward8(Address avatarAddress) : this()
        {
            AvatarAddress = avatarAddress;
        }

        public ClaimStakeReward8()
        {
        }
        ...
        public override IWorld Execute(IActionContext context)
        {
            ...
            var sheets = LegacyModule.GetSheets(world, sheetTypes: new[]
            {
        ...
        private static List<StakeRegularFixedRewardSheet.RewardInfo> GetRegularFixedRewardInfos(
            ...
            int level)
        {
            return LegacyModule.TryGetSheet<StakeRegularFixedRewardSheet>(worldState, out var fixedRewardSheet)
            ...
            foreach (var reward in regularReward)
            {
                ...
                switch (reward.Type)
                {
                    ...
                    case StakeRegularRewardSheet.StakeRewardType.Rune:
                    {
                        ...
                        states = LegacyModule.MintAsset(states, context, AvatarAddress, runeReward);
                        break;
                    }
