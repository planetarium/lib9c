    ...
    public class ReRegisterProduct0 : GameAction
    {
        ...
        public override IWorld Execute(IActionContext context)
        {
            ...
            foreach (var (productInfo, info) in ReRegisterInfos.OrderBy(tuple => tuple.Item2.Type).ThenBy(tuple => tuple.Item2.Price))
            {
                ...
                {
                    world = CancelProductRegistration.Cancel(
                        productsState,
                        productInfo,
                        world,
                        avatarState,
                ...
                world = RegisterProduct0.Register(context, info, avatarState, productsState, world);
            }
            ...
            if (migrationRequired)
            {
                ...
                world = LegacyModule.SetState(world, AvatarAddress.Derive(LegacyWorldInformationKey),
