...
namespace Nekoyume.Action
{
    ...
    public class RegisterProduct2 : GameAction
    {
        ...
        public static IAccount Register(IActionContext context, IRegisterInfo info, AvatarState avatarState, ref List productsState, IAccount states, IRandom random)
        {
            switch (info)
            {
