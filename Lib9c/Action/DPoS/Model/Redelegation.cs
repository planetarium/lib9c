...
namespace Nekoyume.Action.DPoS.Model
{
    public class Redelegation : IEquatable<Redelegation>
    {
        ...
        public static Address DeriveAddress(
            Address delegatorAddress, Address srcValidatorAddress, Address dstValidatorAddress)
        {
            return AddressHelper.Derive(AddressHelper.Derive(AddressHelper.Derive(delegatorAddress, srcValidatorAddress.ToByteArray()), dstValidatorAddress.ToByteArray()), "Redelegation");
        }
