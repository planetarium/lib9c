...
{
    [Serializable]
    public class ShatterStrike : AttackSkill
    {
        public ShatterStrike(
            SkillSheet.Row skillRow,
            long power, int chance,
            int statPowerRatio, StatType referencedStatType
            ...
            IEnumerable<Buff.Buff> buffs, bool copyCharacter)
        {
            ...
            return new Model.BattleStatus.ShatterStrike(SkillRow.Id, clone, damage, buff);
        }
    }
}
