...
namespace Nekoyume.Model.Item
{
    ...
    public class EquipmentPotential
    {
        ...
        /// </summary>
        public static EquipmentPotential Empty { get; } =
            new EquipmentPotential(0, Array.Empty<PotentialOptionSlot>());
        ...
        public EquipmentPotential(int unlockedSlotCount, IReadOnlyList<PotentialOptionSlot> slots)
        {
            ...
            // Defensive copy so a caller cannot mutate this instance's slots after construction,
            // which keeps the shared Empty singleton and every constructed instance effectively immutable.
            Slots = (slots ?? Array.Empty<PotentialOptionSlot>()).ToList();
        }
    ...
    public class PotentialOptionSlot
    {
        ...
        /// Interpreted by the resolver according to the option pool row (e.g. flat add, integer percent, or basis points).
        /// </summary>
        ...
        public PotentialOptionSlot(int optionRowId, long value)
        {
        ...
        public PotentialOptionSlot(IValue serialized)
        {
            ...
            Value = (long)((Integer)list[1]).Value;
        }
