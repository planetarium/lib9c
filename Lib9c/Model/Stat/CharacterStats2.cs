...
namespace Nekoyume.Model.Stat
{
    ...
    public class CharacterStats2 : Stats2, ICharacterStats
    {
        ...
        /// <param name="updateImmediate"></param>
        /// <returns></returns>
        public ICharacterStats SetConsumables(IEnumerable<Consumable> value, bool updateImmediate = true)
        {
        ...
        /// <param name="updateImmediate"></param>
        /// <returns></returns>
        public ICharacterStats SetBuffs(IEnumerable<Buff.StatBuff> value, bool updateImmediate = true)
        {
